//package hash2;
//
//public class AvlTreeImp1 implements AvlTree{
//
//	Node root;
//	
//	@Override
...
//	}
//
//	private void add(Node parent, Node n) {
//		if(parent == null) {
//			//根
//			parent=n;
...
//		}else {
//			if(n<node.data) {
//				//node.left=new Node(n,node.deep+1);
//				add(node.left,n);
//			}else {
//				//node.right=new Node(n,node.deep+1);
//				add(node.right,n);
//			}
//		}
//	}
...
//	}
//
//	private void midOrder(Node root2) {
//		
//	}
//
//	@Override
 ...
 */
public class AvlTreeImp1<AnyType extends Comparable<? super AnyType>> {
	/**
	 * Construct the tree.
	 */
	public AvlTreeImp1() {
